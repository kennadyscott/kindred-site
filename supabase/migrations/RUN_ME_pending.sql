...
--   0031  FIX: "duplicate key ... therapists_slug_key" when saving a profile
--
-- 0031 is the one that matters — it is a live bug blocking profile saves at
-- the end of the signup wizard. The app now retries with an explicit slug so
-- people are not stuck meanwhile, but that is a workaround; this removes the
-- cause.
--
